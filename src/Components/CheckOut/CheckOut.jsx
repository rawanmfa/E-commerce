...
export default function CheckOut() {
    ...
    return <>
        <div className=' w-1/3 mx-auto py-10 bg-gray-50 my-16 rounded-3xl'>
            ...
            <form className=' pt-5 flex flex-col gap-y-5' onSubmit={formik.handleSubmit}>
                <div className="relative z-0 w-4/5 mx-auto group">
                    ...
                    <label htmlFor="details" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-500 duration-300 ps-3 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-7">Enter Your details</label>
                </div>
                <div className="relative z-0 w-4/5 mx-auto group">
                    ...
                    <label htmlFor="city" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-500 duration-300 ps-3 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-green-600 peer-focus:dark:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-7">Enter Your city</label>
                </div>
                <div className="relative z-0 w-4/5 mx-auto group">
